...
class CourseDetail extends Component {
  ...
  hasSubscribed() {
    ...
    return (
      course.StudentIds && course.StudentIds.includes(uid && uid.toUpperCase())
    );
  }
  ...
  async unsubscribe() {
    try {
      ...
      await restClient().put(
        `subscriptioncourses/${uid && uid.toUpperCase()}`,
        {
          CourseId: course.CourseId,
      ...
      >
        <Card className={classes.courseCard}>
          ...
          <CardContent>
            ...
            <Typography component="p">
              Course Duration: {course.courseDuration} minutes
            </Typography>

            <Typography component="p">
              Target Audience: {course.targetAudiences}
            </Typography>

            <Typography component="p">
              Course Detail: {course.courseDetails}
            </Typography>

            <Typography component="p">
              Knowledge Points: {course.knowledgePoints}
            </Typography>
          ...
          <CardActions>
            ...
            <Button
              size="small"
              color="primary"
              onClick={this.redirectAllCourses}
            >
              All Courses
            </Button>
          </CardActions>
